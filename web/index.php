...
<body>
    ...
    <main id="main" class="main">
            ...
            <div class="youtube_official">
                ...
                <div class="youtube_official_txt">
                    <div class="youtube_official_txt1">
                        제주형<br>지역화폐<br><span>'탐나는전'</span>
                    </div>
                    <div class="youtube_official_txt2">
                        11.30일<br>제주형 지역화폐<br><span>'탐나는전'</span> 이 첫 선을 보입니다.<br> 탐나는전 구매 시<br> <span>10% 할인혜택</span>까지!
                    </div>
                </div>
            </div>
            <div class="youtube_kb">
                ...
                <div class="youtube_kb_txt">
                    ...
                    <div class="youtube_kb_txt2">
                        '탐나는전' 체크카드의<br>혜택을 담은 노래,<br><span>'조선의 힘' 이날치</span>가<br>직접 제작한 [탐나는전]의<br>뮤직비디오가 드디어 공개!
                    </div>
                </div>
            </div>
        </article>
        ...
        <section class="link">
            ...
            <ul class="link_box">
                <li class="link_jejutourism"><a href="https://www.ijto.or.kr" title="제주관광공사" target="_blank">제주관광공사</a></li>
                <li class="link_jejugoverment"><a href="http://www.jeju.go.kr" title="제주특별자치도" target="_blank">제주특별자치도</a></li>
                <li class="link_jejusafecode"><a href="https://jshop.jeju.go.kr/index.html#/" title="제주안심코드" target="_blank">제주안심코드</a></li>
            </ul>
        </section>
        <!-- link end -->
